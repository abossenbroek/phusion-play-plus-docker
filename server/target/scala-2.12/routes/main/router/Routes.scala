...
class Routes(
  ...
  // @LINE:6
  Application_1: com.framed.playscalajs.controllers.Application,
  // @LINE:9
  ...
  def documentation = List(
    ("""GET""", this.prefix, """com.framed.playscalajs.controllers.Application.index"""),
  ...
  // @LINE:6
  private[this] lazy val com_framed_playscalajs_controllers_Application_index0_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix)))
  )
  private[this] lazy val com_framed_playscalajs_controllers_Application_index0_invoker = createInvoker(
    Application_1.index,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "com.framed.playscalajs.controllers.Application",
      "index",
      Nil,
      "GET",
      this.prefix + """""",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:6
    case com_framed_playscalajs_controllers_Application_index0_route(params@_) =>
      call { 
        com_framed_playscalajs_controllers_Application_index0_invoker.call(Application_1.index)
      }
